...
export class AddTodo extends Component {
    ...
    onSubmit = async (e) => {
        ...
        axios.post('https://mixinbackendbm.eu-gb.mybluemix.net/todo',{text: this.state.title, id: this.state.id}).then(res => {
            console.log(res);
            console.log(res.data);
        })
        await delay(5000);
        console.log('waited 5 seconds')
        const rootUrl = `https://mixinbackendbm.eu-gb.mybluemix.net/`
